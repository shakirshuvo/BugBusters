...
public class NetflixLogInHassan extends CommonAPI {
    ...
    public static WebElement profileIconHassan;
    ...
    public static WebElement getProfileIconHassan() {return profileIconHassan;}
    ...
    public void clickOnprofileIconHassan() {getProfileIconHassan().click();}
