...
public class NetflixLoginCookie extends CommonAPI {

    @FindBy(how = How.XPATH, using = "//a[@href='/login']")
    public static WebElement signINCWebElement;
    ...
    @FindBy(how = How.XPATH, using = "//a[@class='profile-link']//span[contains(text(),'Cookie')]")
    public static WebElement profileIconCookie;

    public static WebElement getSignINCWebElement() {return signINCWebElement;}
    ...
    public static WebElement getProfileIconCookie() {return profileIconCookie;}

    public void clickSignINC() {getSignINCWebElement().click();}
    ...
    public void clickOnprofileIconCookie() {getProfileIconCookie().click();}
